...
<div class="banner  ">
    <center>
        <img src="{{Voyager::image(setting('servicebanner.seatel1'))}}" alt="" width="" height=>
    </center>
...
.box{
    background-image: linear-gradient(to top, #ec148d 0%, #ec148d 100%);
    border-radius: 10px;
    width: 300px;
    box-shadow:  5px 10px 8px #f45fb4;
