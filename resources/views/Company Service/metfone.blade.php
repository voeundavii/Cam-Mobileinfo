...
<div class="banner  ">
    <center>
        <img src="{{Voyager::image(setting('servicebanner.metfone1'))}}" alt="" width="" height=>
    </center>
...
.box{
    background-image: linear-gradient(to top, #dc1c24 0%, #dc1c24 100%);
    border-radius: 10px;
    width: 300px;
    box-shadow:  5px 10px 8px #e3545c;
